...
const HeroSection = () => {
  return (
    <section className="flex flex-col justify-center items-center mt-10 mb-20">
      <img
      ...
      <h1 className="text-8xl font-bold text-center text-black max-md:text-7xl max-sm:text-5xl leading-tight">
